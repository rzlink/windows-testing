...
# export WINDOWS_CONTAINERD_URL="https://github.com/rzlink/hcsshim/releases/download/test-sandbox-platform-fix/containerd-2.2.1-patched-windows-amd64.tar.gz"
export WINDOWS_CONTAINERD_URL="https://github.com/rzlink/hcsshim/releases/download/test-sandbox-platform-fix-v2/containerd-2.2.1-patched-v0.14-windows-amd64.tar.gz"
export GMSA=""
export HYPERV="true"
export KPNG=""
...
export TOOLS_BIN_DIR="$(dirname "$(realpath "${BASH_SOURCE[0]}")")/tools/bin"
...
# Use public community gallery for Windows node images (bypasses PR #528 private gallery defaults)
export USE_COMMUNITY_GALLERY="true"
